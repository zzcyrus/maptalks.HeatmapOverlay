...
var HeatmapOverlay = function (_maptalks$Layer) {
    ...
    function HeatmapOverlay(id, options) {
        ...
        _this._el = maptalks.DomUtil.createEl('div', 'maptalks-heatmap-layer');
        _this.cfg = options;
    ...
    HeatmapOverlay.prototype.setData = function setData(data) {
        ...
        while (len--) {
            var entry = data[len];
            var latlng = new maptalks.Coordinate(entry[latField], entry[lngField]);
...
HeatmapOverlay.registerRenderer('canvas', function (_maptalks$renderer$Ca) {
    ...
    _class.prototype.draw = function draw() {
        ...
        this._origin = this._map._pointToContainerPoint(new maptalks.Point(0, 0));
    ...
    _class.prototype._update = function _update() {
        ...
        while (len--) {
            ...
            var latlng = new maptalks.Coordinate(entry.latlng);
    ...
    _class.prototype.onResize = function onResize() {
        this._origin = this._map._pointToContainerPoint(new maptalks.Coordinate(0, 0));
        var size = this._map.getSize();
